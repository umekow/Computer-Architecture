...
- Make a list of files here. [ ] cpu.py [ ] ls8.py

- Write a short 3-10-word description of what each file does.
- cpu.py - a class that represents a cpu ls8.py - idk

- Note what has been implemented, and what hasn't.

loading and running cpu
...
- Values themselves should be saved in the **_portion of RAM_** _that is
  ...
  - Make sure you update the stack pointer appropriately as you `PUSH` and `POP`
